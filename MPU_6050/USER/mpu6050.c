...
uint8_t MPU6050_Init()
{
	...
	if(res[0]==MPU_IDNUMBER)
	{
		...
		printf("#%d#",res[0]);
		I2C_ByteWrite(MPU_PWRMGMT1_REG,MPU_6050_ADDR,0x01);
		I2C_ByteWrite(MPU_PWRMGM2_REG,MPU_6050_ADDR,0x00);	
		I2C_ByteWrite(MPU_SAMPLERATE_REG,MPU_6050_ADDR,19);
 	}else return 1;
	return 0;
}
...
void MPU6050_Read_Accel(MPU6050_t *DataStruct)
{
    ...
    // Read 6 BYTES of data starting from ACCEL_XOUT_H register
		// HAL_I2C_Mem_Read(MPU6050_ADDR, ACCEL_XOUT_H_REG, 1, Rec_Data, 6, i2c_timeout);
	
		I2C_BufferRead(Rec_Data,MPU_6050_ADDR,ACCEL_XOUT_H_REG,6);
...
void MPU6050_Read_Gyro(MPU6050_t *DataStruct)
{
    ...
    // Read 6 BYTES of data starting from GYRO_XOUT_H register
		...
		I2C_BufferRead(Rec_Data,MPU_6050_ADDR,0x43,6);
...
//    HAL_I2C_Mem_Read(I2Cx, MPU6050_ADDR, TEMP_OUT_H_REG, 1, Rec_Data, 2, i2c_timeout);
		I2C_BufferRead(Rec_Data,MPU_6050_ADDR,TEMP_OUT_H_REG,2);		
...
void MPU6050_Read_All(MPU6050_t *DataStruct)
{
    ...
    // Read 14 BYTES of data starting from ACCEL_XOUT_H register
		...
		I2C_BufferRead(Rec_Data,MPU6050_ADDR, ACCEL_XOUT_H_REG,14);
    ...
    // Kalman angle solve
//    double dt = (double)(Get_Sytick()) / 1000;
		double dt = 0;
//    timer = Get_Sytick();
    double roll;
